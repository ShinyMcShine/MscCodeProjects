function [cfg,cdat] = ft_singleplotTFR(cfg, data)
...
if isequal(cfg.masknans, 'yes') && isempty(cfg.maskparameter)
  ...
  [cdat] = ft_plot_matrix(xval, yval, zval, 'clim', [zmin zmax], 'tag', 'cip', 'highlightstyle', cfg.maskstyle, 'highlight', mask);
...
elseif isequal(cfg.masknans, 'no') && ~isempty(cfg.maskparameter)
  ...
  [cdat] = ft_plot_matrix(xval, yval, zval, 'clim', [zmin zmax], 'tag', 'cip');
end
