...
for s = 1:11
    ...
    images1 = cat(3,images1,eval(var_test_images{1}));
    images2 = cat(3,images2,eval(var_test_images{2}));
    test_class_labels1 = vertcat(test_class_labels1,eval(var_test_labels{1}));
    test_class_labels2 = vertcat(test_class_labels2,eval(var_test_labels{2}));
