function [test_class_labels, train_class_labels, test_image_matrix, train_image_matrix] = load_all_train_test_cross_validation (channels,file_path)
for q = 1:11
...
%% Cropping images to display from 0 seconds to -250 miliseconds
